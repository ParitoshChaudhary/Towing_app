...
public class UnderVehicle extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_undervehicle);
		...
		UnderHome = (LinearLayout) findViewById(R.id.under_home);
		UnderHome.setOnClickListener(this);
		Typeface typeface2 = Typeface.createFromAsset(getAssets(),"fonts/Helvetica.otf");
//		 text.setTypeface(typeface2);
		new undervehicleinfo().execute();
	...
	private class undervehicleinfo extends AsyncTask<String, String, String> {

		@Override
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(UnderVehicle.this);
